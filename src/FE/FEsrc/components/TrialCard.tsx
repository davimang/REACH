        ...
        <TrialContainer key={trial.NCTId} style={{backgroundColor: isSelected[trial.NCTId] ? '#021691': '#38569A'}}>
            <TrialDescription>
                <TrialTitle
                    onClick={(e) => {
                        e.preventDefault();
                        setCurrentLocation({ latitude: trial.LocationLatitude, longitude: trial.LocationLongitude, address: trial.LocationFacility + ' ' + trial.LocationCity + ' ' + (trial.LocationState ? trial.LocationState : "") + ' ' + trial.LocationZip});
