...
filtering_dict_boolean = {
    ...
    "onAntifibroticTherapy": (
        "antifibrotic+therapy+OR+Nintedanib+OR+Pirfenidone+OR+Pirfenidone"
    ),
    "IPFDiagnosis": "idiopathic+pulmonary+fibrosis",
    "autoimmuneDiagnosis": (
        "auto+immune+OR+rheumatoid+OR+Scleroderma+OR+Scleroderma+OR+Myositis"
    ),
...
# packYears : float
# phGroup : int
# additionalSleepDisorder : str, one of [OSA, OSA/OHS, hypoventilation,
# central sleep apnea, insomnia, narcolepsy, idiopathic hypersomnia,
# RBD, NREM parasomnia, RLS]
# BMI : float
# apneadIndex : float
