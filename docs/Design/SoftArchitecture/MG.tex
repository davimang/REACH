...
\item[Implemented By:] Third-party logon server.
...
\begin{description}
  ...
  \item[Implemented By:] TrialFetcher.py \\
\end{description}
...
\begin{description}
  ...
  \item[Implemented By:] TrialFilterer,py \\
\end{description}
...
\begin{description}
  ...
  \item[Implemented By:] EmailNotifier.py  \\
\end{description}
