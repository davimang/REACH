...
This project is primarily based around matching patients with medical conditions to appropriate medical studies corresponding to their medical condition. This matching is done either by the patient or on behalf of a patient by their clinician. The system will allow the users to search for trials based on their medical conditions, and will allow them to store their data for ease of search. The system will return a listing of trials to which the patient can apply.
