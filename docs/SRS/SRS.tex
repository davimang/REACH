...
The customers for this project are people who are looking to take part in a research study and clinicinas who are looking for reseach studies for their patients.

\medskip
\noindent\textbf{General User Characteristics}
\begin{itemize}
    \item \textbf{Age:} 18+
    \item \textbf{Education:} Varies (not assumed to know medical terminology)
    \item \textbf{Technical Experience:} Some experience navigating web applications
\end{itemize}

\noindent\textbf{Clinician Characteristics}
\begin{itemize}
    \item \textbf{Age:} 18+
    \item \textbf{Education:} Medical degree (knowledge of medical terminology relevant to their patients is assumed)
    \item \textbf{Technical Experience:} Some experience navigating web applications
\end{itemize}
...
\textbf{FR-4, FR-5:}
\noindent These requirements are not critical to the core functionality of the application, and will be implemented after the core functionality is complete.

\noindent \textbf{FR-11:}
\noindent This requirement is a low priority, and will be implemented after higher priority requirements are completed.
