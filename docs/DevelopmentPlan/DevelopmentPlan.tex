...
Jira issues (which are also referred to as tickets) and assign those to the appropriate team members. 
...
and that the eligibility criteria provided by the clinical trial is often in natural language. 
...
The data provided by the clinical trials being in natural language also is a risk as we will 
have to research and use a natural language processor to extract the relevant data points. 

Therefore to demonstrate that we can overcome these risks our proof of concept demonstrations will have to both 
be deployed and able to be accessed from a device that is not running the source code, 
and the application must be able to extract the requirements for the clinical trial from the data source. 
Also the application should be able to display the retrieved requirements in a GUI of some fashion.
