...
\begin{enumerate}
	...
	\item The dev team will review the pull request, provide feedback and request changes if necessary. 
...
Therfore to demonstrate that we can overcome these risks our proof of concept demonstrations will have to both be deployed and able to be ascessed from a device that is not running the source code, and the application must be able to extract the requirements for the clinical trial from the data source. Also the application should be able to display the retreived requiremnts in a GUI of some fashion.
