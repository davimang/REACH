...
\begin{table}[htbp]
    ...
    \begin{tabular}{|c|c|p{10cm}|}
        ...
        testing and verification pertaining to JS and TS frameworks, automated cloud deployment, graphical interface and presentation.\\
        \hline
        Deep & Dev Team & As the testing SME, Deep will lead the majority of the testing efforts, he will focus on both
        front- and back-end testing and will lend his expertise to front- and back-end SMEs whn they focus on end-to-end testing. \\
        \hline
